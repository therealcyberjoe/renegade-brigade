const FACTION_GREY_KNIGHTS = [
  ...
  { id:'gk_draigo', name:'Lord Kaldor Draigo',
    stats:['5"','2+','2+','5','5','8','5','9','2+'], role:'HQ', pts:225, min:1, max:1, ppm:0,
  ...
  { id:'gk_voldus', name:'Grand Master Voldus',
    stats:['5"','2+','2+','4','4','6','5','9','2+'], role:'HQ', pts:165, min:1, max:1, ppm:0,
  ...
  { id:'gk_stern', name:'Brother-Captain Stern',
    stats:['5"','2+','2+','4','4','6','5','9','2+'], role:'HQ', pts:145, min:1, max:1, ppm:0,
  ...
  { id:'gk_crowe', name:'Castellan Crowe',
    stats:['6"','2+','2+','4','4','5','7','9','3+'], role:'HQ', pts:100, min:1, max:1, ppm:0,
