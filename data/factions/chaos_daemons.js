const FACTION_CHAOS_DAEMONS = [
  ...
  // ── NAMED CHARACTERS ────────────────────────────────────────────────
  { id:'cd_skulltaker', name:'Skulltaker', unique:true,
    stats:['6"','2+','3+','4','3','4','4','10','5+'], role:'HQ', pts:110, min:1, max:1, ppm:0,
    wargear:["Slayer Sword",'Cloak of Skulls'],
    abilities:['Daemonic: 5+ invulnerable save',
               'Collector of Skulls: Re-roll all failed hit and wound rolls against Characters',
               'Decapitating Strike: Unmodified wound rolls of 6 deal D3 mortal wounds in addition',
               'The Skull Throne: Friendly Bloodletters within 12" re-roll Morale tests'] },

  { id:'cd_karanak', name:'Karanak — the Three-Headed Hound', unique:true,
    stats:['10"','3+','4+','4','4','5','4','10','5+'], role:'Elites', pts:75, min:1, max:1, ppm:0,
    wargear:['Claws and Fangs x3'],
    abilities:['Daemonic: 5+ invulnerable save',
               'Prey of the Blood God: At start of battle designate one enemy Character — Karanak re-rolls all failed hit and wound rolls against that model',
               'Brass Collar of Bloody Vengeance: This model may attempt to Deny one psychic power per phase',
               'Unfettered Ferocity: Always fight first on the turn it charges',
               'Pack Leader: Friendly Flesh Hounds within 6" gain +1 Attack'] },

  { id:'cd_changeling', name:'The Changeling', unique:true,
    stats:['6"','4+','3+','3','3','4','2','10','5+'], role:'HQ', pts:90, min:1, max:1, ppm:0,
    wargear:["The Trickster's Staff"],
    abilities:['Daemonic: 5+ invulnerable save',
               'Psyker: Mastery Level 1 — knows Smite + 1 Tzeentch power',
               'Illusory Form: Enemy units that target this model must first pass a Leadership test — if failed they cannot target it this phase',
               'Mutable Form: At start of each battle round choose one — +1 to hit rolls, or +1 to save rolls, or +1 to wound rolls',
               'Architect of Deception: Friendly Tzeentch Daemons within 9" may re-roll Morale tests'] },

  { id:'cd_kugath', name:"Ku'Gath Plaguefather", unique:true,
    stats:['8"','3+','3+','7','7','18','4','10','4+'], role:'HQ', pts:250, min:1, max:1, ppm:0,
    wargear:['Bile Blade','Noxious Bile Spewer','Plague Drones'],
    abilities:["Daemonic: 4+ invulnerable save",
               'Disgustingly Resilient: 5+ Feel No Pain',
               "Plagued Cauldron: At the start of your turn if Ku\'Gath is alive roll D6 — on 4+ add 1 Nurgling Swarm within 1",
               'Roiling Decay: Enemy units within 3" subtract 1 from their Toughness characteristic',
               "Grandfather's Caress: Friendly Nurgle Daemons within 7\" re-roll hit rolls of 1"] },

  { id:'cd_masque', name:'The Masque of Slaanesh', unique:true,
    stats:['8"','3+','3+','3','3','4','5','10','5+'], role:'Elites', pts:80, min:1, max:1, ppm:0,
    wargear:['Staff of Masks','Slaaneshi Claw'],
    abilities:['Daemonic: 5+ invulnerable save',
               'Unending Dance: At start of each Fight phase this model fights first regardless of who charged',
               "Eternal Dance: This model never suffers penalties to hit rolls for any reason",
               'The Staff of Masks: Once per game force one enemy Character within 6" to fight last in the Fight phase',
               'Inhuman Reflexes: -1 to hit rolls targeting this model in the Shooting phase'] },
