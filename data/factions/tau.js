var FACTION_TAU = [
  ...
  { id:'tau_commander', name:'Commander in Coldstar Battlesuit',
    ...
    options:[
      { group:'Hardpoint 2', choices:[
        { label:'High-output Burst Cannon (default)', pts:0,  default:true },
        { label:'Fusion Blaster',                     pts:18, weapons:['Fusion Blaster'] },
        { label:'Missile Pod',                        pts:22, weapons:['Missile Pod'] },
        { label:'Plasma Rifle',                       pts:14, weapons:['Plasma Rifle'] },
        { label:'Cyclic Ion Blaster',                 pts:15, weapons:['Cyclic Ion Blaster'] },
      ]},
      { group:'Hardpoint 3', choices:[
        { label:'None',                               pts:0,  default:true },
        { label:'Fusion Blaster',                     pts:18, weapons:['Fusion Blaster'] },
        { label:'Missile Pod',                        pts:22, weapons:['Missile Pod'] },
        { label:'Shield Generator',                   pts:8,  weapons:['Shield Generator'] },
        { label:'Target Lock',                        pts:5,  weapons:['Target Lock'] },
      ]},
      { group:'Hardpoint 4', choices:[
        { label:'None',                               pts:0,  default:true },
        { label:'Shield Generator',                   pts:8,  weapons:['Shield Generator'] },
        { label:'Target Lock',                        pts:5,  weapons:['Target Lock'] },
        { label:'Velocity Tracker',                   pts:8,  weapons:['Velocity Tracker'] },
      ]},
    ],
    abilities:['For the Greater Good: When a friendly unit within 6" is charged this unit may fire Overwatch for free',
               ...
               'Coldstar: 16" Move — cannot be targeted by Overwatch'] },

  { id:'tau_commander_crisis', name:"Commander in Crisis Battlesuit",
    stats:['8"','5+','2+','5','5','6','3','9','3+'], role:'HQ', pts:90, min:1, max:1, ppm:0,
    wargear:['Burst Cannon','Burst Cannon'],
    options:[
      { group:'Hardpoint 1', choices:[
        { label:'Burst Cannon',                  pts:7,  default:true, weapons:['Burst Cannon'] },
        { label:'Cyclic Ion Blaster',            pts:15, weapons:['Cyclic Ion Blaster'],            replaces:['Burst Cannon'] },
        { label:'Fusion Blaster',                pts:18, weapons:['Fusion Blaster'],                replaces:['Burst Cannon'] },
        { label:'Flamer',                        pts:6,  weapons:['Flamer'],                        replaces:['Burst Cannon'] },
        { label:'Missile Pod',                   pts:22, weapons:['Missile Pod'],                   replaces:['Burst Cannon'] },
        { label:'Plasma Rifle',                  pts:14, weapons:['Plasma Rifle'],                  replaces:['Burst Cannon'] },
        { label:'Smart Missile System',          pts:14, weapons:['Smart Missile System'],          replaces:['Burst Cannon'] },
        { label:'Airbursting Fragmentation Proj',pts:10, weapons:['Airbursting Fragmentation Projector'], replaces:['Burst Cannon'] },
      ]},
      { group:'Hardpoint 2', choices:[
        { label:'Burst Cannon',                  pts:7,  default:true, weapons:['Burst Cannon'] },
        { label:'Cyclic Ion Blaster',            pts:15, weapons:['Cyclic Ion Blaster'],            replaces:['Burst Cannon'] },
        ...
        { label:'Plasma Rifle',                  pts:14, weapons:['Plasma Rifle'],                  replaces:['Burst Cannon'] },
        { label:'Smart Missile System',          pts:14, weapons:['Smart Missile System'],          replaces:['Burst Cannon'] },
        { label:'Shield Generator (Support)',    pts:8,  weapons:['Shield Generator'],              replaces:['Burst Cannon'] },
      ]},
      { group:'Hardpoint 3', choices:[
        { label:'None',                          pts:0,  default:true },
        { label:'Burst Cannon',                  pts:7,  weapons:['Burst Cannon'] },
        { label:'Cyclic Ion Blaster',            pts:15, weapons:['Cyclic Ion Blaster'] },
        { label:'Fusion Blaster',                pts:18, weapons:['Fusion Blaster'] },
        { label:'Missile Pod',                   pts:22, weapons:['Missile Pod'] },
        { label:'Target Lock (Support)',         pts:5,  weapons:['Target Lock'] },
        { label:'Multi-tracker (Support)',       pts:5,  weapons:['Multi-tracker'] },
        { label:'Shield Generator (Support)',    pts:8,  weapons:['Shield Generator'] },
        { label:'Command-link Drone',            pts:16, weapons:['Command-link Drone'] },
      ]},
      { group:'Hardpoint 4', choices:[
        { label:'None',                          pts:0,  default:true },
        { label:'Target Lock (Support)',         pts:5,  weapons:['Target Lock'] },
        { label:'Multi-tracker (Support)',       pts:5,  weapons:['Multi-tracker'] },
        { label:'Shield Generator (Support)',    pts:8,  weapons:['Shield Generator'] },
        { label:'Velocity Tracker (Support)',    pts:8,  weapons:['Velocity Tracker'] },
        { label:'Drone Controller (Support)',    pts:5,  weapons:['Drone Controller'] },
      ]},
    ],
    abilities:['For the Greater Good: Friendly units within 6" may fire Overwatch for free when this unit is charged',
               'Manta Strike: Deep strike — arrive 9"+ from enemy',
               '4+ invulnerable save',
               'Up to 4 hardpoints — mix weapons and support systems freely'] },
