const FACTION_ELDAR = [
  ...
  { id:'el_eldrad', name:'Eldrad Ulthran',
    stats:['7"','3+','2+','3','3','5','2','9','6+'], role:'HQ', pts:130, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_asurmen', name:'Asurmen — Hand of Asuryan',
    stats:['7"','2+','2+','3','3','6','5','9','2+'], role:'HQ', pts:180, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_jain_zar', name:'Jain Zar — Storm of Silence',
    stats:['8"','2+','2+','3','3','5','6','9','4+'], role:'HQ', pts:140, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_karandras', name:'Karandras — The Shadow Hunter',
    stats:['7"','2+','2+','4','3','5','5','9','3+'], role:'HQ', pts:165, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_fuegan', name:'Fuegan, The Burning Lance',
    stats:['7"','2+','2+','4','4','6','5','9','3+'], role:'HQ', pts:165, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_baharroth', name:'Baharroth, Cry of the Wind',
    stats:['14"','2+','2+','3','3','5','5','9','4+'], role:'HQ', pts:120, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_yriel', name:'Prince Yriel',
    stats:['7"','2+','2+','4','3','5','6','9','3+'], role:'HQ', pts:100, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_irillyth', name:'Irillyth, Shade of Twilight',
    stats:['12"','2+','2+','3','3','6','4','9','4+'], role:'HQ', pts:140, min:1, max:1, ppm:0, isNew:true,
  ...
  { id:'el_lhykhis', name:'Lhykhis, Warp Spider Exarch',
    stats:['7"','2+','2+','3','3','5','5','9','3+'], role:'Elites', pts:110, min:1, max:1, ppm:0, isNew:true,
