...
var CSM_SHARED_UNITS = [
  { id:'csm_lord', name:'Chaos Lord',
    ...
    options:[
      { group:'Melee', choices:[
        ...
        { label:'Lightning Claw', pts:5,  weapons:['Lightning Claw'], replaces:['Power Sword'] },
        { label:'Chainaxe',       pts:0,  weapons:['Chainaxe'],       replaces:['Power Sword'] },
        { label:'Daemon Sword',   pts:5,  weapons:['Daemon Sword'],   replaces:['Power Sword'] },
      ]},
      { group:'Sidearm', choices:[
        ...
        { label:'Combi-plasma',   pts:10, weapons:['Combi-plasma'],  replaces:['Bolt Pistol'] },
        { label:'Combi-bolter',   pts:2,  weapons:['Combi-Bolter'],  replaces:['Bolt Pistol'] },
      ]},
    ],
  ...
  { id:'csm_sorcerer', name:'Chaos Sorcerer',
    ...
    options:[
      { group:'Force Weapon', choices:[
        { label:'Force Stave',  pts:0, default:true, weapons:['Force Stave'] },
        { label:'Force Sword',  pts:0, weapons:['Force Sword'],  replaces:['Force Stave'] },
        { label:'Force Axe',    pts:0, weapons:['Force Axe'],    replaces:['Force Stave'] },
      ]},
      { group:'Sidearm', choices:[
        { label:'Bolt Pistol',   pts:0,  default:true, weapons:['Bolt Pistol'] },
        { label:'Plasma Pistol', pts:5,  weapons:['Plasma Pistol'], replaces:['Bolt Pistol'] },
  ...
  { id:'csm_warp_talons', name:'Warp Talons',
    ...
    wargear:[],
    composition:[
      { role:'Warp Talon Champion', count:1, wargear:['Lightning Claws x2','Jump Pack'] },
      { role:'Warp Talon',          count:4, wargear:['Lightning Claws x2','Jump Pack'] },
    ],
    abilities:['Daemonic: 5+ invulnerable save',
               'Veterans of the Long War',
               ...
               'No weapon options — all models carry twin lightning claws'] },
  ...
  { id:'csm_predator', name:'Chaos Predator',
    ...
    options:[
      { group:'Turret', choices:[
        { label:'Predator Autocannon', pts:0,  default:true, weapons:['Predator Autocannon'] },
        { label:'Twin Lascannon',      pts:30, weapons:['Twin Lascannon'], replaces:['Predator Autocannon'] },
      ]},
      ...
      { group:'Pintle', choices:[
        { label:'None',                pts:0, default:true },
        { label:'Combi-Bolter',        pts:2, weapons:['Combi-Bolter'] },
        { label:'Combi-melta',         pts:10,weapons:['Combi-melta'] },
        { label:'Havoc Launcher',      pts:7, weapons:['Havoc Launcher'] },
      ]},
    ],
  ...
  { id:'csm_land_raider', name:'Chaos Land Raider',
    ...
    abilities:['Daemonic: 5+ invulnerable save',
               'Power of the Chaos Machine Spirit: May fire one weapon even if it moved',
  ...
  { id:'csm_maulerfiend', name:'Maulerfiend',
    ...
    wargear:['Power Fists','Lasher Tendrils'],
    options:[
      { group:'Arm Option', choices:[
        { label:'Lasher Tendrils',  pts:0, default:true, weapons:['Lasher Tendrils'] },
        { label:'Magma Cutters',    pts:0, weapons:['Magma Cutters (Maulerfiend)'], replaces:['Lasher Tendrils'] },
      ]},
    ],
    abilities:['Daemonic: 5+ invulnerable save',
               'Frenzy: Add 1 to Attacks if charged or charged this turn',
               'Lasher Tendrils: Enemy units within 1" subtract 1 from their Attack characteristic',
  ...
  { id:'csm_mutilators', name:'Mutilators', isNew:true,
    stats:['5"','3+','3+','5','7','5','4','8','2+'], role:'Elites', pts:200, min:3, max:3, ppm:0,
    wargear:['Fleshmetal Weapons'],
    abilities:['Daemonic: 5+ invulnerable save',
               'Deep Strike: May be set up in reserves and arrive 9"+ from enemy',
               'Fleshmetal Weapons: Choose one profile per Fight phase — Clawed Sweeps (8A S5 AP-1 D1) or Rending Strikes (4A S6 AP-2 D2) or Thunderous Blows (2A S10 AP-3 D3)',
               'Crushing Charge: Re-roll charge rolls — on completing a Charge move roll D6 per model, each 4+ deals D3 mortal wounds to one enemy unit in Engagement Range'] },
  ...
  { id:'csm_rhino', name:'Chaos Rhino',
    ...
    options:[
      { group:'Main Gun', choices:[
        { label:'Combi-Bolter',  pts:0,  default:true, weapons:['Combi-Bolter'] },
        { label:'Combi-melta',   pts:10, weapons:['Combi-melta'],  replaces:['Combi-Bolter'] },
        { label:'Combi-plasma',  pts:10, weapons:['Combi-plasma'], replaces:['Combi-Bolter'] },
        { label:'Combi-flamer',  pts:5,  weapons:['Combi-flamer'], replaces:['Combi-Bolter'] },
      ]},
      { group:'Pintle', choices:[
        { label:'None',           pts:0, default:true },
        { label:'Havoc Launcher', pts:7, weapons:['Havoc Launcher'] },
