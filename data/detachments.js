...
const DETACHMENT_RULES = {
  battalion: { cp: 5, hq: [2,3], troops: [3,6], elites: [0,6], fast: [0,3], heavy: [0,3], flyer: [0,2], dedicated: [0,'∞'], lord: [0,1], fortification: [0,0] },
  brigade: { cp: 9, hq: [3,5], troops: [6,12], elites: [3,8], fast: [3,8], heavy: [3,8], flyer: [0,2], dedicated: [0,'∞'], lord: [0,1], fortification: [0,0] },
